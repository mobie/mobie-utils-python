...
class TransformixRegistrationBase(luigi.Task):
    """ TransformixRegistration base class
    """
...
class TransformixRegistrationLocal(TransformixRegistrationBase, LocalTask):
    """
    TransformixRegistration on local machine
    """
    pass


class TransformixRegistrationSlurm(TransformixRegistrationBase, SlurmTask):
    """
    TransformixRegistration on slurm cluster
    """
    pass


class TransformixRegistrationLSF(TransformixRegistrationBase, LSFTask):
    """
    TransformixRegistration on lsf cluster
    """
    pass
...
def transformix_registration(job_id, config_path):
...
if __name__ == '__main__':
    ...
    transformix_registration(job_id, path)
